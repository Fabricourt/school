...
def central(request):
    ...
    noticeg7 = Notice.objects.all().filter(is_grade8=True)
    noticeg6 = Notice.objects.all().filter(is_grade8=True)
    noticeg5 = Notice.objects.all().filter(is_grade8=True)
    noticeg4 = Notice.objects.all().filter(is_grade8=True)
    noticeg3 = Notice.objects.all().filter(is_grade8=True)
    noticeg2 = Notice.objects.all().filter(is_grade8=True)
    noticeg1 = Notice.objects.all().filter(is_grade8=True)
